...
std::vector<size_t> RcppUtilities::convert_integer_vector(Rcpp::IntegerVector input_vector) {
	std::vector<size_t> output_vector;
	for (int integer : input_vector) {
		output_vector.push_back((size_t)integer);
	}
